...
import { generateTextFromGemini } from "../_shared/gemini.ts";
...
Only output the pitch text, nothing else.`;
      ...
      const personalizedPitch = await generateTextFromGemini({
        systemInstruction: "You are an expert at writing personalized cold emails that get responses. Be concise and genuine.",
        prompt: aiPrompt,
        temperature: 0.4,
      });
