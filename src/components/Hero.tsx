        ...
        animationDelay: "0.4s"
          ...
          <div className="clean-card mx-auto max-w-2xl p-2 shadow-card">
            <div className="relative">
              ...
              <Input type="text" placeholder="Search companies, industries, or locations..." value={searchQuery} onChange={e => onSearchChange(e.target.value)} className="h-14 w-full rounded-xl border-0 bg-transparent pl-14 pr-5 text-base transition-all duration-300 focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-muted-foreground/60" />
            </div>
          </div>
        </div>
