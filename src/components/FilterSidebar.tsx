...
const filterSections: FilterSection[] = [
  {
    ...
    options: [
      ...
      { value: "ai", label: "AI & Machine Learning", count: 54 },
      { value: "health", label: "Health & Biotech", count: 24 },
      { value: "devtools", label: "Developer Tools", count: 24 },
      { value: "fintech", label: "Finance & Fintech", count: 13 },
      { value: "enterprise", label: "Enterprise & B2B", count: 22 },
      { value: "consumer", label: "Consumer", count: 22 },
      { value: "hardware", label: "Hardware & Robotics", count: 17 },
      { value: "climate", label: "Climate & Energy", count: 10 },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "sf", label: "San Francisco Bay Area", count: 22 },
      { value: "nyc", label: "New York", count: 5 },
      { value: "us-other", label: "Other US Cities", count: 25 },
